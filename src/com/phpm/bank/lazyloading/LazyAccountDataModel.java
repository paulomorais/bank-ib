...
import com.phpm.bank.client.service.AccountService;
...
public class LazyAccountDataModel extends LazyDataModel<Account> {
    ...
    public List<Account> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String,Object> filters) {
		...
		System.err.println("accountNumberFilter = " + accountNumberFilter);
		System.err.println("usernameFilter = " + usernameFilter);
		System.err.println("username = " + username);
		System.err.println("list.size() = " + list.size());
		System.err.println("accountService.rowCount(usernameFilter) = " + accountService.rowCount(usernameFilter));
